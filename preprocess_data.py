...
if __name__ == '__main__':
    ...
    train_data = create_utterances('data/train_9.json', 'train')
    valid_data = create_utterances('data/train_9_valid.json', 'validation')
    test_data = create_utterances('data/train_9_test.json', 'test')
    ...
    pickle.dump(act_label_encoder, open('chatgpt_data2/act_label_encoder.pkl', 'wb'))
    pickle.dump(act_label_decoder, open('chatgpt_data2/act_label_decoder.pkl', 'wb'))
    pickle.dump(emotion_label_encoder, open('chatgpt_data2/emotion_label_encoder.pkl', 'wb'))
    pickle.dump(emotion_label_decoder, open('chatgpt_data2/emotion_label_decoder.pkl', 'wb'))
    ...
    pickle.dump(tokenizer, open('chatgpt_data2/tokenizer.pkl', 'wb'))
    ...
    pickle.dump([convSpeakers, convInputSequence, convInputMaxSequenceLength, convActLabels, convEmotionLabels,
                 train_conv_ids, test_conv_ids, valid_conv_ids], open('chatgpt_data2/dialogue.pkl', 'wb'))
